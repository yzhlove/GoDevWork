...
func (*Cache) Descriptor() ([]byte, []int) {
	return fileDescriptor_cache_d6a1f81722276dcd, []int{0}
}
...
func (*Cache_Req) Descriptor() ([]byte, []int) {
	return fileDescriptor_cache_d6a1f81722276dcd, []int{0, 0}
}
...
func (dst *Cache_Req) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Cache_Req.Merge(dst, src)
}
...
func (*Cache_Resp) Descriptor() ([]byte, []int) {
	return fileDescriptor_cache_d6a1f81722276dcd, []int{0, 1}
}
...
func (dst *Cache_Resp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Cache_Resp.Merge(dst, src)
}
...
func init() { proto.RegisterFile("cache.proto", fileDescriptor_cache_d6a1f81722276dcd) }

var fileDescriptor_cache_d6a1f81722276dcd = []byte{
