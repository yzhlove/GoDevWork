...
func (z *Code) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		case "Used":
			z.Used, bts, err = msgp.ReadUint32Bytes(bts)
			if err != nil {
...
func (z *Code) Msgsize() (s int) {
	s = 1 + 3 + msgp.Uint32Size + 8 + msgp.StringPrefixSize + len(z.FixCode) + 4 + msgp.Uint32Size + 10 + msgp.Int64Size + 8 + msgp.Int64Size + 13 + msgp.Uint16Size + 13 + msgp.Uint16Size + 8 + msgp.ArrayHeaderSize + (len(z.ZoneIds) * (msgp.Uint32Size)) + 6 + msgp.ArrayHeaderSize + (len(z.Items) * (8 + msgp.Uint32Size + msgp.Int32Size)) + 5 + msgp.Uint32Size
	return
}
